...
public class TextUserInterface {
    ...
    private void set(ArrayList<String> commands) {
        try {
            switch (commands.get(1)) {
                case "WORK": {
                    model.setWork(model.getComponent(commands.get(2)).workNodes.get(Integer.parseInt(commands.get(3))), OptionalDouble.of(Double.parseDouble(commands.get(4))));
                    break;
                }
                case "HEAT": {
                    model.setHeat(model.getComponent(commands.get(2)).heatNodes.get(Integer.parseInt(commands.get(3))), OptionalDouble.of(Double.parseDouble(commands.get(4))));
                    break;
                }
                case "MASS": {
                    model.setMass(model.getComponent(commands.get(2)).flowNodes.get(Integer.parseInt(commands.get(3))), OptionalDouble.of(Double.parseDouble(commands.get(4))));
                    break;
                }
                case "STATE": {
